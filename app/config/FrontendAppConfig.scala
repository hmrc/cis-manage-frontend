...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  private lazy val pasBaseUrl: String                               = configuration.get[String]("microservice.services.pas.host")
  private lazy val noticeViewerBaseUrl: String                      = configuration.get[String]("microservice.services.notice-viewer.host")
