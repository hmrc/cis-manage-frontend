...
class DeleteAmendedMonthlyReturnViewSpec extends SpecBase {
  ...
  "DeleteAmendedMonthlyReturnView" - {
    ...
    "must render the page with the correct html elements (English) including monthYear" in new Setup {
      ...
      doc.title must include(messagesEn("delete.deleteAmendedMonthlyReturn.title", monthYearEn))
      doc.title must include(monthYearEn)

      doc.select("h1").text must include(messagesEn("delete.deleteAmendedMonthlyReturn.heading", monthYearEn))
    ...
    "must render the page with the correct html elements (Welsh) including monthYear" in new Setup {
      ...
      doc.title must include(messagesCy("delete.deleteAmendedMonthlyReturn.title", monthYearCy))
      doc.title must include(monthYearCy)

      doc.select("h1").text must include(messagesCy("delete.deleteAmendedMonthlyReturn.heading", monthYearCy))
