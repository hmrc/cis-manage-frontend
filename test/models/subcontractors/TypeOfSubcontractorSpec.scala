...
class TypeOfSubcontractorSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {

  "TypeOfSubcontractor" - {

    "must deserialise valid values" in {

      val gen = Gen.oneOf(TypeOfSubcontractor.values)
