...
class DeleteMonthlyReturnControllerSpec extends SpecBase with MockitoSugar {
  ...
  val baseUa: UserAnswers = userAnswersWithCisId
    .set(
      ...
      UnsubmittedMonthlyReturnsRow(3000L, 2026, 4, "Standard", "In Progress", None, Some("N"), true)
    )
    .success
    .value

  lazy val deleteMonthlyReturnRoute: String =
    controllers.delete.routes.DeleteMonthlyReturnController.onPageLoad().url
  ...
  "DeleteMonthlyReturn Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseUa.set(DeleteMonthlyReturnPage, true).success.value
